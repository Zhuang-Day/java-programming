 ...
 * @description With in-depth association rule manipulation
...
public class AssociationRules_Apriori_3 {

	public static void main(String[] args) {
		AssociationRules_Apriori_3 ara = new AssociationRules_Apriori_3();
		ara.runAssociator();
	}
	...
	public void runAssociator() {
		try {
			...
			for(AssociationRule rule : rules) {
				...
				String[] mns = rule.getMetricNamesForRule();
				double[] mvs = rule.getMetricValuesForRule();
				String pmn = rule.getPrimaryMetricName();
				double pmv = rule.getPrimaryMetricValue();
				int sup_p = rule.getPremiseSupport();
				int sup_c = rule.getConsequenceSupport();
				int sup_t = rule.getTotalSupport();
				
				System.out.println("MetricNamesForRule: "+Arrays.toString(mns));
				System.out.println("MetricValuesForRule: "+Arrays.toString(mvs));
				System.out.println("PrimaryMetricName: "+pmn);
				System.out.println("PrimaryMetricValue: "+pmv);
				System.out.println("PremiseSupport: "+sup_p);
				System.out.println("ConsequenceSupport: "+sup_c);
				System.out.println("TotalSupport: "+sup_t);
